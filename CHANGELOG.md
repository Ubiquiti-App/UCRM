...
### Added
*	UCRM API upgraded with new getters (of collections and single entities too) and new filters for Invoice getter. You can filter Invoices or Payments by the Create date. Please refer to API documentaion for UCRM beta: http://docs.ucrmbeta.apiary.io
...
*	Fixed data synchronization from some types of Mikrotik devices.
